        ...
        <div className="w-full">
          ...
          <div className="mt-20 grid grid-cols-1 gap-14 lg:mt-[5.25rem] lg:grid-cols-12 lg:gap-x-8">
            <section aria-labelledby="footer-contact" className="lg:col-span-6">
              ...
              <p className="max-w-[540px] text-[14px] leading-[1.65] text-white/60 lg:text-[15px]">
            ...
            <div className="grid gap-12 sm:grid-cols-2 lg:col-span-3 lg:grid-cols-1 lg:gap-11">
              <section aria-labelledby="business-enquiries">
                <h2 id="business-enquiries" className="mb-3 text-[12px] font-normal uppercase text-white/45">
                  Business enquiries
                </h2>
                <a className="text-[14px] hover:underline lg:text-[15px]" href="mailto:vinus@vinus.co.kr">
                  vinus@vinus.co.kr
                </a>
                <p className="mt-2 whitespace-nowrap text-[13px] text-white/55 lg:text-[14px]">
                  TEL : 02-3661-1907&nbsp;&nbsp; FAX : 02-3661-1906
                </p>
              </section>

              <section aria-labelledby="open-positions">
                <h2 id="open-positions" className="mb-3 text-[12px] font-normal uppercase text-white/45">
                  Open positions
                </h2>
            ...
            <div className="grid gap-12 sm:grid-cols-2 lg:col-span-3 lg:grid-cols-1 lg:gap-11">
              <section aria-labelledby="business-hours">
                <h2 id="business-hours" className="mb-3 text-[12px] font-normal uppercase text-white/45">
                  Business hours
                </h2>
                <p className="text-[14px] font-medium uppercase lg:text-[15px]">Monday to Friday</p>
                <p className="mt-2 text-[13px] text-white/55 lg:text-[14px]">10:00 AM – 18:00 PM GMT (+9)</p>
              </section>

              <section aria-labelledby="korea-office">
                <h2 id="korea-office" className="mb-3 text-[12px] font-normal uppercase text-white/45">
                  Korea
                </h2>
