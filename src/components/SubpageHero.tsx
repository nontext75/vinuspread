...
export function SubpageHero({
  ...
  return (
    <section ref={ref} className={cn("subpage-header overflow-hidden", heroHeightClasses[size], className)}>
      <motion.div className="subpage-header-inner will-change-transform" style={{ y: reduceMotion ? 0 : heroY }}>
        <div className="subpage-label-stack">
          ...
          <motion.span aria-hidden="true" className="subpage-rule" initial={initial} animate={visible} transition={transition(0.08)} />
        </div>
        <div className="subpage-copy-stack">
          <motion.h1 className="subpage-title" initial={initial} animate={visible} transition={transition(0.1)}>{title}</motion.h1>
          <motion.p className="subpage-lead" initial={initial} animate={visible} transition={transition(0.16)}>{description}</motion.p>
        </div>
      </motion.div>
    </section>
  );
