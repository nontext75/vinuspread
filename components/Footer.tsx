...
import ZeroGravityButton from '@/components/ui/ZeroGravityButton';
            ...
            <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row justify-between items-start gap-12">
                <div className="md:w-1/2">
                    ...
                    <ZeroGravityButton
                        ...
                        className="inline-flex items-center gap-2 px-8 py-4 bg-black text-white hover:bg-slate-800 hover:shadow-[0_0_30px_rgba(0,0,0,0.3)]"
                    >
                        CONTACT US
                    </ZeroGravityButton>
                </div>
