                                ...
                                <div className="relative z-10 w-full text-left">
                                    ...
                                    >
                                        <div className="flex flex-wrap items-center gap-4 mb-8">
                                            ...
                                            <div className="flex items-center gap-2 text-white/50 text-xs font-mono tracking-widest uppercase"><Calendar size={12} /><span>{project.year} Creative Archive</span></div>
                                        </div>
                                        <h1 className="text-7xl md:text-9xl font-black tracking-tighter uppercase leading-[0.8] mb-12">
                                            {project.title || 'Untitled Project'}
                                        </h1>
                                        <p className="text-lg md:text-xl text-zinc-400 font-light max-w-2xl leading-relaxed border-l border-white/20 pl-8">
                                            {project.description}
                                        </p>
                                    </motion.div>
                                </div>
                                        ...
                                        {project.content ? (() => {
                                            try {
                                                if (project.content.trim().startsWith('[') || project.content.trim().startsWith('{')) {
                                                    ...
                                                    return <ProjectBlockRenderer blocks={blocks} motionType={project.motion_type as any} />;
                                                }
                                            } catch (e) {
